...
Future<List<String>?> pickFolder(Function(String) getNameCharacter) async {
  ...
  if (selectFolder == null) {
    ...
    getNameCharacter(nameCharacter_);
...
Future<List<String>?> fileOfFolder(String pathFolder) async {
  List<String> listPathImage = (await Directory(pathFolder).list().toList()).map((e) => e.path).toList();
  return listPathImage;
}
